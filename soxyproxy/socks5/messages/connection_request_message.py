...
from soxyproxy.socks5 import Socks5Commands, Socks5AddressTypes
from soxyproxy.socks5.messages.const import (SOCKS5_ADDRESS_OCTET_LENGTH, SOCKS5_ADDRESS_PORT_BYTES_LENGTH,
                                             SOCKS5_PACKAGE_RESERVED_VALUE, SOCKS5_ADDRESS_PORT_BYTE_ORDER)
...
class Socks5ConnectionRequestMessage(RequestMessage):
    ...
    def from_bytes(raw: bytes):
        ...
        return Socks5ConnectionRequestMessage(action=connection_type,
    ...
    def get_port_from_raw(raw: bytes) -> int:
        return int.from_bytes(bytes=raw[DESTINATION_PORT_SLICE], byteorder=SOCKS5_ADDRESS_PORT_BYTE_ORDER)
